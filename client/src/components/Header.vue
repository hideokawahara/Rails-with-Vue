<template>
  <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-dark border-bottom box-shadow">
    <h5 class="my-0 mr-md-auto font-weight-normal"><a href="/" class="text-white">ホーム画面</a></h5>
    <nav class="my-2 my-md-0 mr-md-3">
      ...
      <router-link to="/record_tags" class="p-2 text-white" v-if="signedIn()">タグ</router-link>
