  ...
  <header class="bg-grey-lighter py-4">
    <div class="container m-auto flex flex-wrap items-center justify-end">
      ...
      <div>
        ...
        <router-link to="/details" class="link-grey px-2 no-underline" v-if="signedIn()">Records</router-link>
        <router-link to="/record_tags" class="link-grey px-2 no-underline" v-if="signedIn()">Artists</router-link>
